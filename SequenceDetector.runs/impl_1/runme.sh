...
HD_PWD='E:/BrunelUniversity/YR3/EmbeddedSystems/SequenceDetector/SequenceDetector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SequenceDetector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SequenceDetector.tcl -notrace
