...
HD_PWD='E:/BrunelUniversity/YR3/EmbeddedSystems/SequenceDetector/SequenceDetector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SequenceDetector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SequenceDetector.tcl
